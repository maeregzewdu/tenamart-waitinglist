    ...
    <body class="font-['Raleway']">
            ...
            <div class="px-6 md:px-16 pt-8">
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-sm text-neutral-700 font-medium">
                        <a class="hover:underline cursor-pointer" onclick="document.getElementById('nameInput').focus()" >Join the waitlist</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <div id="hero" class="py-40 md:py-40 flex flex-col items-center justify-center relative">
            ...
            <div class="max-w-2xl w-full space-y-4 md:space-y-6 text-center content-wrapper">
                ...
                <h1 class="text-3xl md:text-5xl font-bold text-[#10b982] mb-2 md:mb-4 leading-[1.3]">The Future of Pharmacies <br> in Ethiopia – Coming Soon.</h1>
        ...
        <section id="how-it-works" class="py-24 px-6 md:py-28 bg-white">
            <div class="max-w-6xl mx-auto">
                <div class="text-center space-y-6 mb-12 md:mb-16">
                    <img src="{{ asset('images/how-it-works.svg') }}" alt="How it works illustration" class="mx-auto h-18 md:h-24 opacity-90">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <!-- Customers Card -->
                    <div class="bg-white rounded-xl md:rounded-2xl border border-neutral-200 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-3 mb-6">
                            <span class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-[#10b982]/10 text-[#10b982]">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-4">
                                <span class="flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#10b982] ring-1 ring-[#10b982]/50 text-sm font-semibold">1</span>
                                <div>
                                    <p class="font-medium text-neutral-900">Search & find medicines</p>
                                    <p class="text-neutral-600 text-sm md:text-base">Browse verified pharmacies, compare options, and see availability near you.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                <span class="flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#10b982] ring-1 ring-[#10b982]/50 text-sm font-semibold">2</span>
                                <div>
                                    <p class="font-medium text-neutral-900">Place your order</p>
                                    <p class="text-neutral-600 text-sm md:text-base">Add items to your cart and securely submit your order in a few taps.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                <span class="flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#10b982] ring-1 ring-[#10b982]/50 text-sm font-semibold">3</span>
                                <div>
                                    <p class="font-medium text-neutral-900">Get fast delivery or pickup</p>
                                    <p class="text-neutral-600 text-sm md:text-base">Receive your medicines at your door, or pick them up at a nearby pharmacy.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-neutral-600 text-sm md:text-base">Create your profile and verify your pharmacy to start receiving orders.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                <span class="flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#10b982] ring-1 ring-[#10b982]/50 text-sm font-semibold">2</span>
                                <div>
                                    ...
                                    <p class="text-neutral-600 text-sm md:text-base">Upload products, set prices, and keep stock updated with simple tools.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4">
                                <span class="flex-shrink-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#10b982] ring-1 ring-[#10b982]/50 text-sm font-semibold">3</span>
                                <div>
                                    ...
                                    <p class="text-neutral-600 text-sm md:text-base">Prepare orders for delivery or pickup, reach more customers, and grow sales.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="why-us" class="bg-neutral-50 py-24 px-6 md:py-28">
            <div class="mx-auto max-w-6xl">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <!-- Customers -->
                    <div class="bg-white rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200 overflow-hidden">
                        <div class="mb-10">
                            <img class="w-full" src="{{ asset('images/customer-snapshot-cropped.png') }}" alt="">
                        </div>
                        <div class="p-8">
                            <div class="flex items-center gap-3 mb-6">
                                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#10b982]/10 text-[#10b982]">
                            ...
                            <div class="grid gap-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="text-sm text-neutral-600">We partner only with verified pharmacies.</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="text-sm text-neutral-600">Compare pharmacies, prices, and delivery options near you.</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="text-sm text-neutral-600">Upload prescriptions, pay safely, and track orders in real time.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-8">
                            ...
                            <div class="grid gap-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="text-sm text-neutral-600">Get discovered citywide and serve more customers digitally.</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="text-sm text-neutral-600">Manage stock, branches, staff, and orders in one dashboard.</p>
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="text-sm text-neutral-600">Use promotions and analytics to maximize growth.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="py-24 md:py-28 px-6 bg-white">
            <div class="mx-auto max-w-6xl">
                <div class="text-center mb-12">
                    ...
                    <p class="text-neutral-600 text-sm md:text-base mt-2">Milestones that show we’re building for real impact</p>
                </div>

                <!-- Achievement Badges -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <!-- Card 1 -->
                    <div class="relative overflow-hidden bg-white border border-neutral-200 rounded-xl p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                        <div class="absolute inset-0 pointer-events-none" style="background: radial-gradient(600px circle at 0 0, rgba(16,185,130,0.06), transparent 40%);"></div>
                        <div class="flex gap-3 items-start">
                            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#10b982]/10 text-[#10b982] flex-shrink-0">
                                <i class="ri-trophy-line text-2xl leading-none"></i>
                            </span>
                            <div class="space-y-1">
                                <p class="font-semibold text-neutral-900">2nd Place — Biruh Competition</p>
                                <p class="text-neutral-600 text-sm">Achieved city-wide recognition for our innovative business solution and team execution</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Card 2 -->
                    <div class="relative overflow-hidden bg-white border border-neutral-200 rounded-xl p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                        <div class="absolute inset-0 pointer-events-none" style="background: radial-gradient(600px circle at 100% 0, rgba(16,185,130,0.06), transparent 40%);"></div>
                        <div class="flex gap-3 items-start">
                            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#10b982]/10 text-[#10b982] flex-shrink-0">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-neutral-600 text-sm">Successfully raised capital to accelerate development and prepare for a strong product launch</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Card 3 -->
                    <div class="relative overflow-hidden bg-white border border-neutral-200 rounded-xl p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-0.5">
                        <div class="absolute inset-0 pointer-events-none" style="background: radial-gradient(600px circle at 50% 0, rgba(16,185,130,0.06), transparent 40%);"></div>
                        <div class="flex gap-3 items-start">
                            <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#10b982]/10 text-[#10b982] flex-shrink-0">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-neutral-600 text-sm">Becoming Ethiopia’s leading digital pharmacy platform connecting users and verified pharmacies seamlessly</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section id="faq" class="py-24 md:py-28 px-6 bg-white">
            <div class="mx-auto max-w-6xl">
                <div class="text-center mb-10 md:mb-12">
                    ...
                    <p class="text-neutral-600 text-sm md:text-base mt-3">Everything you need to know about using TenaMart</p>
                </div>

                <div>
                    <!-- Item 1 -->
                    <div class="faq-item border-b border-neutral-200 bg-white p-5 md:p-6 transition-all duration-200">
                        <button type="button" class="faq-toggle cursor-pointer w-full flex items-center justify-between gap-6 text-left" aria-expanded="false" aria-controls="faq-1">
                        ...
                        <div id="faq-1" class="faq-answer hidden mt-3 text-neutral-600 text-sm md:text-base">
                            TenaMart is a platform that connects customers with verified pharmacies to order medicines online for delivery or pickup.
                        </div>
                    </div>

                    <!-- Item 2 -->
                    <div class="faq-item border-b border-neutral-200 bg-white p-5 md:p-6 transition-all duration-200">
                        <button type="button" class="faq-toggle cursor-pointer w-full flex items-center justify-between gap-6 text-left" aria-expanded="false" aria-controls="faq-2">
                        ...
                        <div id="faq-2" class="faq-answer hidden mt-3 text-neutral-600 text-sm md:text-base">
                            Search for your medicines, choose a pharmacy, add items to your cart, and securely submit your order. You can track progress in real time.
                        </div>
                    </div>

                    <!-- Item 3 -->
                    <div class="faq-item border-b border-neutral-200 bg-white p-5 md:p-6 transition-all duration-200">
                        <button type="button" class="faq-toggle cursor-pointer w-full flex items-center justify-between gap-6 text-left" aria-expanded="false" aria-controls="faq-3">
                        ...
                        <div id="faq-3" class="faq-answer hidden mt-3 text-neutral-600 text-sm md:text-base">
                            A valid prescription is required for prescription-only medicines. You can upload a photo during checkout.
                        </div>
                    </div>

                    <!-- Item 4 -->
                    <div class="faq-item border-b border-neutral-200 bg-white p-5 md:p-6 transition-all duration-200">
                        <button type="button" class="faq-toggle cursor-pointer w-full flex items-center justify-between gap-6 text-left" aria-expanded="false" aria-controls="faq-4">
                        ...
                        <div id="faq-4" class="faq-answer hidden mt-3 text-neutral-600 text-sm md:text-base">
                            We verify licenses and compliance before a pharmacy goes live, and we continuously monitor quality and reliability.
                        </div>
                    </div>

                    <!-- Item 5 -->
                    <div class="faq-item border-b border-neutral-200 bg-white p-5 md:p-6 transition-all duration-200">
                        <button type="button" class="faq-toggle cursor-pointer w-full flex items-center justify-between gap-6 text-left" aria-expanded="false" aria-controls="faq-5">
                        ...
                        <div id="faq-5" class="faq-answer hidden mt-3 text-neutral-600 text-sm md:text-base">
                            Delivery fees vary by distance and pharmacy. You’ll see the exact cost before you confirm your order.
                        </div>
                    </div>

                    <!-- Item 6 -->
                    <div class="faq-item bg-white p-5 md:p-6 transition-all duration-200">
                        <button type="button" class="faq-toggle cursor-pointer w-full flex items-center justify-between gap-6 text-left" aria-expanded="false" aria-controls="faq-6">
                        ...
                        <div id="faq-6" class="faq-answer hidden mt-3 text-neutral-600 text-sm md:text-base">
                            Submit your details to join the waitlist <a onclick="document.getElementById('nameInput').focus()" class="cursor-pointer text-[#10b982] hover:underline">here</a>. We’ll reach out to verify your information and help you get set up.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mx-auto max-w-6xl">
                <div class="relative overflow-hidden rounded-2xl border border-neutral-200 bg-gradient-to-br from-[#10b982]/5 via-white to-white p-8 md:p-12 shadow-sm">
                    ...
                    <div class="relative text-center max-w-2xl mx-auto">
                        ...
                        <p class="text-neutral-600 text-sm md:text-base mt-3">Join the waiting list to get early access, updates, and launch perks.</p>

                        <div class="mt-6 md:mt-8">
                            <a onclick="document.getElementById('nameInput').focus()"  class="relative cursor-pointer w-fit px-6 py-3 rounded-full font-semibold text-white bg-[#10b982] mx-auto inline-flex items-center gap-2 overflow-hidden transition-all duration-200 hover:bg-[#0fa972] hover:shadow-md hover:-translate-y-0.5">
                                <!-- White dotted pattern -->
                                <span class="absolute inset-0 bg-[radial-gradient(white_1px,transparent_1px)] [background-size:10px_10px] opacity-20"></span>
        ...
        <footer class="w-full bg-white">
            <div class="w-full relative max-w-[1600px] mx-auto">
                <div class=" w-full mx-auto px-6 md:px-12 lg:px-16 xl:px-36 py-16 md:py-32 items-center flex justify-center">
                    <div class="flex flex-col max-w-[1200px]  items-center justify-center w-full gap-8">
                        <div class="flex flex-col  md:flex-row items-center justify-center w-full gap-20 md:gap-8 md:justify-between md:items-stretch">
                            ...
                            <div class="flex flex-col gap-8 items-center justify-center underline md:items-start md:flex-1">
                            ...
                            <div class="flex flex-col gap-8 items-center justify-center underline md:items-end md:flex-1">
                                <a class="active:text-neutral-700" href="/terms">Terms of Service</a>
                                <a class="active:text-neutral-700" href="/data-processing">Data Processing Agreement</a>
                                <a class="active:text-neutral-700" href="/privacy-policy">Privacy Policy</a>
                            </div>
                        </div>
                        <span class="text-neutral-600 text-base font-normal tracking-[normal] leading-[24px] text-center">© 2025 TenaMart, All rights reserved.</span>
                    </div>
                </div>
            </div>
        </footer>
